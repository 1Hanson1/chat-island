...
const router = createRouter({
  ...
  routes: [ 
    ...
    { path: '/home', name: 'Home', component: Home, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/check', name: 'Check', component: Check, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/assistantSquareMain', name: 'AssistantSquareMain', component: AssistantSquareMain, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/assistantSquareMainAssPage', name: 'AssistantSquareMainAssPage', component: AssistantSquareMainAssPage, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/assistantSquareMainToolsPage', name: 'AssistantSquareMainToolsPage', component: AssistantSquareMainToolsPage, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/assistant/:id', name: 'AssistantDetails', component: AssistantDetails, meta: { requiresAuth: true, roles: ['NORMAL'] }, props: true },
    { path: '/tool/:id', name: 'ToolDetails', component: ToolDetails, meta: { requiresAuth: true, roles: ['NORMAL'] }, props: true },
    { path: '/purchase', name: 'Purchase', component: Purchase, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/login', name: 'Login', component: Login },
    { path: '/register', name: 'Register', component: Register},
    { path: '/quickCreate', name: 'QuickCreate', component: QuickCreate, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/sourceGoDown', name: 'SourceGoDown', component: SourceGoDown, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/chatWithPeople', name: 'ChatWithPeople', component: ChatWithPeople, meta: { requiresAuth: true, roles: ['NORMAL'] } }, 
    { path: '/helpWord', name: 'HelpWord', component: HelpWord, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/personal/Info', name: 'PersonalInfo', component: PersonalInfo, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    { path: '/personal/Statistic', name: 'PersonalStatistic', component: PersonalStatistic, meta: { requiresAuth: true, roles: ['NORMAL'] } },
    ...
    { path: '/settings/:id', name: 'SetDetails', component: SetDetails, meta: { requiresAuth: true, roles: ['NORMAL'] }, props: true },
  ],
});
